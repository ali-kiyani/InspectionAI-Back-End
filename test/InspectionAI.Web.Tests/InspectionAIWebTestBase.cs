...
{
    public abstract class InspectionAIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static InspectionAIWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(InspectionAIWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<InspectionAIDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<InspectionAIDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<InspectionAIDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<InspectionAIDbContext, Task<T>> func)
        {
            T result;

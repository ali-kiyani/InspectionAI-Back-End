...
namespace InspectionAI.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly InspectionAIDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = InspectionAIConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(InspectionAIDbContext context)
        {
            _context = context;
        }
